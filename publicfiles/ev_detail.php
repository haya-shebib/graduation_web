...
<img src="../upload_vid/confirence_holo1.png" style="width:100%;">
  ...
  <div class="mySlides w3-display-container w3-center">
    <img src="../upload_vid/live.png" style="width:100%">
    <div class="w3-display-bottommiddle w3-container w3-text-white w3-padding-32 w3-hide-small">
      <h3>EASY RENT</h3>
...
<div class="services-container">
    ...
    <BR></BR>
    <p>Suitable for Large event expos of min. 3 x 5 meters, staffed brand activations.Unique ability to create a human hologram. vailable for rent -DeepFrame One display Rental periods From 1 week up to 6 months. </p>
    <BR></BR>
...
<div class="swiper-wrapper">
    ...
    <div class="swiper-slide trending__swiper-slide">
        ...
        <video controls style="width: 400px;  height:400px;">
            <source src="../upload_vid/video_holo2.mp4" type="video/mp4">
    ...
    <div class="swiper-slide trending__swiper-slide">
        <div class="trending__card">
        <video controls style="width: 400px;  height:400px;">
            <source src="../upload_vid/video.mp4" type="video/mp4">
            Your browser does not support the video tag.
        </video>
    ...
    <div class="swiper-slide trending__swiper-slide">
        <div class="trending__card">
        <video controls style="width: 400px;  height:400px;">
            <source src="../upload_vid/vide3.mp4" type="video/mp4">
            Your browser does not support the video tag.
        </video>
  ...
  <div class="home-content">
                <h3>Holographic display<span> Human 3D</span></h3>
...
<div class="about-content">
  ...
  <BR></BR>
            <p><span>1;HARDWARE </span> HUMAN SIZE 3D Holographic IN LONG SMARTV HOLOGRAM </p>
              <p><span>2; CONTENT</span> WE COSTOMISE YOUR 3D CONTENT </p>
              <p><span>3; </span> Can be installed at a distance</p>
            ...
            <div class="home-img">
            <img src="../upload_vid/ph.png" style="width: 600px; height: 600px;">
            </div>
